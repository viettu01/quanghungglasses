...
export class ProductService {
  ...
  search(name: string, pageSize: number, pageNumber: any, originNames: string[], brandNames: string[], materialNames: string[], shapeNames: string[], timeWarranties: any[],
                     priceMin: number, priceMax: number) {
    let queryParams = new HttpParams();
    queryParams = queryParams.append("page-size", pageSize);
    queryParams = queryParams.append("page-number", pageNumber);
    ...
    queryParams = queryParams.append("price-min", priceMin);
    queryParams = queryParams.append("price-max", priceMax);
    return this.http.get(`${this.apiProductUrl}/search`, {params: queryParams});
  }
