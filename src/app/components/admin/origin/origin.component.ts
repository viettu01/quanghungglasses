  ...
  create() {
    ...
    this.originService.create(this.brandForm.value).subscribe({
      next: () => {
        ...
        this.updateTable();
        this.toastr.success('Thêm xuất xứ thành công', 'Thông báo');
      },
      error: (error: any) => {
  ...
  update() {
    ...
    this.originService.update(this.brandForm.value).subscribe({
      next: () => {
        ...
        this.btnCloseModal.nativeElement.click();
        this.updateTable();
        this.toastr.success('Cập nhật xuất xứ thành công', 'Thông báo');
      },
      error: (error: any) => {
        this.errorMessage = error.error;
        this.isDisplayNone = false;
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.originService.delete(id).subscribe({
          next: () => {
            this.updateTable();
            this.toastr.success('Xóa xuất xứ thành công', 'Thông báo');
          },
          error: (error: any) => {
